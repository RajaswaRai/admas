...
if (!empty($_SESSION['nik'])) {
    ...
    $sql_pengaduan = "SELECT * FROM pengaduan pa INNER JOIN masyarakat ma ON pa.nik = ma.nik WHERE `status`='selesai' ORDER BY id_pengaduan DESC";
